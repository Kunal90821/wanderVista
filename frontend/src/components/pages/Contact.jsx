...
const Contact = () => {
  return (
    <>
      <div className="bg-white px-8 py-2 lg:ml-8 ml-2 mt-4 main pb-8 shadow-xl">
        <div className="text-center w-full text-6xl text-[#2B2D42] mt-8 font-bold animate-fade-in-up">
          WanderVista
        </div>
        <div className="max-w-screen-xl  mt-10 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-xl">
